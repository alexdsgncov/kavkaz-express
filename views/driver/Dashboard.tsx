      ...
      <header className="flex justify-between items-center">
        <div>
          <div className="flex items-center gap-2 mb-1">
             ...
             <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Telegram DB Connected</p>
          </div>
      ...
      <div className="space-y-4">
        {trips.length === 0 ? (
          <div className="py-20 text-center border-2 border-dashed border-slate-200 rounded-[40px] text-slate-300">
             ...
             <p className="font-bold mt-2">Нет записей в БД</p>
          </div>
        ) : (
          trips.map(trip => (
            <div key={trip.id} className="bg-white p-6 rounded-[32px] border border-slate-100 shadow-xl shadow-slate-200/40 space-y-5 animate-in slide-in-from-bottom-4">
                 ...
                 <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-1 mt-1 text-[10px] font-bold text-slate-400">
                        ...
                        <span>Row ID: {trip.id.slice(-6)}</span>
                      </div>
                    </div>
                 </div>
              ...
              <div className="flex gap-2">
                 ...
                 <button onClick={() => onDeleteTrip(trip.id)} className="px-6 py-4 bg-red-50 text-red-500 rounded-2xl active:bg-red-100">
